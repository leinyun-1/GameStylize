...
class LightningModelForTrain(pl.LightningModule):
    def __init__(self,args):
        ...
        if model == 't2v_1.3b':
            dit_path='/dockerdata/Wan2.1-T2V-1.3B/diffusion_pytorch_model.safetensors'
        elif model == 'i2v_14b':
            dit_path = [
                "/dockerdata/Wan2.1-I2V-14B-480P/diffusion_pytorch_model-00001-of-00007.safetensors",
                "/dockerdata/Wan2.1-I2V-14B-480P/diffusion_pytorch_model-00002-of-00007.safetensors",
                "/dockerdata/Wan2.1-I2V-14B-480P/diffusion_pytorch_model-00003-of-00007.safetensors",
                "/dockerdata/Wan2.1-I2V-14B-480P/diffusion_pytorch_model-00004-of-00007.safetensors",
                "/dockerdata/Wan2.1-I2V-14B-480P/diffusion_pytorch_model-00005-of-00007.safetensors",
                "/dockerdata/Wan2.1-I2V-14B-480P/diffusion_pytorch_model-00006-of-00007.safetensors",
                "/dockerdata/Wan2.1-I2V-14B-480P/diffusion_pytorch_model-00007-of-00007.safetensors",
            ]
    ...
    def training_step(self, batch, batch_idx):
        ...
        if "clip_feature" in batch:
            image_emb["clip_feature"] = batch["clip_feature"][0].to(self.device)
        if "y" in batch:
...
if __name__ == "__main__":
    ...
    'learning_rate': 1e-4,
    'dataset': 'ngr',
    'dataset_root': '/root/leinyu/data/ngr/ngr_clip_latent',    
    'latent_len': 21,
    'devices': [4,5,6,7],
    'lora_rank': 32,
    'batch_size': 3,
